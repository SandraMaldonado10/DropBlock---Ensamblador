...
;*************************************************************************************  
  ...
  PintaEntorno PROC 
    ...
    push dx
    push ax
    push di ; MODIFICACION 1
    
    lea dx, decoTablero
    call ImprimirCadena 
    
    ; ****** MODIFICACION 1: EMPEZAR CON 5 VIDAS E IRLAS PERDIENDO ******
    ...
    loop buclePintaVidas
    
    call ImprimirCadena
    
    mov di, 5 ; Contador que se ira restando segun las vidas que vayan quedando 
    ...
    mov di, 1 ; COMODIN MODIFICACION 3
  ...
  ComandoEntrada PROC
    ...
    IntroducirColumna:
        ...
        ; *** MODIFICACION 3: poner un comodin que borre la primera fila del tablero ***
       ; cmp al, 'c'
        ;je comodin
    ...
    siguePartida:
        ...
        comprobarCeldasIguales: 
            ...
            noIguales:
                ...
                ;  **** MODIFICACION 2: compactar numeros iguales que estan al lado **** 
                
                ;cmp [si+2], ax
;                je compactarLaterales
